...
{{--    @if(app()->getLocale()=='ar')--}}
        ...
        <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@300&family=El+Messiri&display=swap" rel="stylesheet"><style>
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="{{route('dashboard')}}" class="brand-logo">
                    <img  style="width: 230px ;height: 130px" alt="Logo" src="{{asset('assets/images/logo.png')}}"  />
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
                ...
                <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
                    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-2">
                            <!--begin::Page Title-->
                            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><a href="{{route('dashboard')}}"> الرئيسية</a>|</h5>
                            <!--end::Page Title-->
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="text-muted mt-1">مدير الكفي</div>
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
